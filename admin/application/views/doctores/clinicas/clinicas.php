                ...
                <div class="panel panel-inverse panel-with-tabs" data-sortable-id="index-2">
                    ...
                    <div class="panel-heading p-0">
                      ...
                      <div align="right">
                        ...
                        <a href="<?php echo  base_url('Docs/adm_agregar_clinica') ?>" class="btn btn-success">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><center><?php echo $key->telefono; ?></center></td>
                                         ...
                                         <td>
                                            <center>
                                                 <a href="<?php echo  base_url('Docs/adm_eliminar_clinica/').$key->id ?>" class="btn btn-danger">
                                                <span class="glyphicon glyphicon-trash"></span>eliminar</a>

                                                <a href="<?php echo  base_url('Docs/adm_editar_clinica/').$key->id ?>" class="btn btn-success">
