                ...
                <div class="panel panel-inverse panel-with-tabs" data-sortable-id="index-2">
                    <div class="panel-heading p-0">
                        <div class="panel-heading-btn m-r-10 m-t-10">
                           <a href="<?php echo  base_url('Docs/insert_clinicas') ?>" class="btn btn-success">
                    ...
                    <div class="tab-content">
                            ...
                            <p><a href="<?php echo  base_url('clinicas-medico/') ?>" class="btn btn-info"></span>Ir a Panel de Administración</a></p>
                    <br>
