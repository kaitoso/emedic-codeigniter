			...
			<div id="header" class="header navbar navbar-default navbar-fixed-top">
				...
				<div class="container-fluid">
					...
					<div class="navbar-header">
						<a href="<?php base_url('Usuario/home') ?>" class="navbar-brand"><span class="navbar-logo"></span> eMedic</a>
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							<a href="<?php echo base_url('Docs/miperfil/').$info['user_id'] ?>" data-toggle="dropdown" class="dropdown-toggle f-s-14">
						...
						<li class="dropdown navbar-user">
							...
							<ul class="dropdown-menu animated fadeInLeft">
								<li class="arrow"></li>
								<li><a href="<?php echo base_url('Docs/miperfil/').$info['user_id'] ?>">Editar perfil</a></li>
