			...
			<div id="sidebar" class="sidebar">
				...
				<div data-scrollbar="true" data-height="100%">
					...
					<ul class="nav">
						...
						<li><a href="<?php echo base_url('inicio/') ?>" data-toggle="ajax"><i class="icon-home"></i> <span>Inicio</span></a></li>
						<li><a href="<?php echo base_url('pacientes/') ?>" data-toggle="ajax"><i class="medicon-paciente"></i> <span>Pacientes</span></a></li>
						...
						<li><a href="<?php echo base_url('Usuario/consultas') ?>" data-toggle="ajax"><i class="medicon-medical-2"></i> <span>Consultas médicas</span></a></li>
						<li><a href="<?php echo base_url('Usuario/medicamentos') ?>" data-toggle="ajax"><i class="medicon-pill"></i> <span>Medicamentos</span></a></li>
						<li class="has-sub">
						    <a href="javascript:;">
