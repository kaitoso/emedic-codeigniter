   <?php 
        ...
        echo form_open_multipart('Usuario/editar_paciente/',$attributes);
    ?>
         <?php
			$campo = array(
				'name'  => 'id_paciente',
				'id'  => 'id_paciente',
				'value' => set_value('id_paciente',$paciente->id),
	          ...
	          <div class="col-sm-10">
	            <?php
                  $campo = array(
                      ...
                      'value'=>set_value('apellidomat',$paciente->apellido_materno),
                      'class' => 'form-control',
		...
		<div class="row">
	      <div class="col-md-12">
	        <div class="form-group">
				...
				<input type="hidden" name="tfecha" id="tfecha" name="tfecha" value="<?php echo $paciente->fecha_nacimiento ?>">
	            <p class="help-block text-danger"></p>
	          </div>
	        </div>
	      </div>
	          ...
	          <div class="col-sm-10">
	              <div class='input-group date' id='datepicker'>
	                <?php
                      ...
                      'class' => 'form-control',
                      'data-validation-required-message' => 'Por favor indique su fecha de nacimiento',
                      'required' => ''
                      );
	          ...
	          <div class="col-sm-10">
	            <?php
                  $campo = array(
                      ...
                      'value'=>set_value('prof',$paciente->profesion),
                      'class' => 'form-control',
	    ...
	    <div class="row">
	      <div class="col-md-12">
	        <div class="form-group">
	          ...
	          <div class="col-sm-10">
		        <input type="hidden" id="sex_selected" value="<?php echo $paciente->sexo ?>">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="hidden" id="prev_selected" value="<?php echo $paciente->prevision ?>">
	    ...
	    <div class="row">
	      <div class="col-md-12">
	        <div class="form-group">
	          ...
	          <div class="col-sm-10">  
		        <input type="hidden" id="reg_selected" value="<?php echo $paciente->region ?>">
	    ...
	    <div class="row">
	      <div class="col-md-12">
	        <div class="form-group">
	          ...
	          <div class="col-sm-10">
    	        <input type="hidden" id="prov_selected" value="<?php echo $paciente->provincia ?>">
	    ...
	    <div class="row">
	      <div class="col-md-12">
	        <div class="form-group">
	          ...
	          <div class="col-sm-10">
    	        <input type="hidden" id="com_selected" value="<?php echo $paciente->comuna ?>">
		...
		<div class="row hidden">
	        <div class="col-md-12 text-center">
	            <button type="submit" class="btn btn-xl btn-success" id="submit_edit_paciente">Actualizar</button>
	        </div>
	    </div>
