<div id="content" class="content">
        <!-- begin page-header -->
        <h3 class="page-header">Migrar Citas</h3>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <div class="col-12">
              ...
              <?php } ?>
                ...
                <div class="panel panel-inverse panel-with-tabs" data-sortable-id="index-2">
                    ...
                    <div class="tab-content">
                          ...
                          echo form_open_multipart('Usuario/migra_citas/');
                        ...
                        <select class="form-control" id="medico" name="medico">
                          ...
                          <option>Selecione Medico</option>

                          <?php if (isset($medicos) and is_array($medicos) and count($medicos)>0) {
                            # code...
                        ...
                        <select class="form-control" id="presentacion" name="presentacion">
                          ...
                          <option>Selecione Prestación</option>

                          <?php if (isset($presentacion) and is_array($presentacion) and count($presentacion)>0) {
                            # code...
                ...
                <strong>El archivo tiene que ser en formato Csv o puede descargar el archivo llenarlo y subirlo directamente</strong>
                        ...
                        <div class="row">
                          <div class="col-md-12 text-center">
                            ...
                            <a data-toggle="tooltip" title="" href="<?php echo base_url().'img'.'/migraciones'.'/citas/'.'citas.csv' ?>" class="btn btn-danger" data-original-title="Descarga el archivo para el reporte"><i class="fa fa-download"></i> Descargar reporte para llenado</a>
