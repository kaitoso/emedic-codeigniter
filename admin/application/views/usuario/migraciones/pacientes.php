<div id="content" class="content">
        <!-- begin page-header -->
        <h3 class="page-header">Migrar Pacientes</h3>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <div class="col-12">
              ...
              <?php } ?>
                ...
                <div class="panel panel-inverse panel-with-tabs" data-sortable-id="index-2">
                    ...
                    <div class="tab-content">
                          ...
                          echo form_open_multipart('Usuario/migra_pacientes/');
                ...
                <strong>El archivo tiene que ser en formato Csv o puede descargar el archivo llenarlo y subirlo directamente</strong>
                        ...
                        <div class="row">
                          <div class="col-md-12 text-center">
                            ...
                            <a data-toggle="tooltip" title="" href="<?php echo base_url().'img'.'/migraciones'.'/pacientes/'.'pacientes.csv' ?>" class="btn btn-danger" data-original-title="Descarga el archivo para el reporte"><i class="fa fa-download"></i> Descargar reporte para llenado</a>
