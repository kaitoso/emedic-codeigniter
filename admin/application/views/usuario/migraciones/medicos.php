<div id="content" class="content">
        <!-- begin page-header -->
        <h3 class="page-header">Migrar Personal</h3>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <div class="col-12">
              ...
              <?php } ?>
                ...
                <div class="panel panel-inverse panel-with-tabs" data-sortable-id="index-2">
                    ...
                    <div class="tab-content">
                          ...
                          echo form_open_multipart('Usuario/migra_medicos/');
                        ...
                        <select class="form-control" id="grupos" name="grupos">
                          ...
                          <option>Selecione Personal</option>

                          <?php if (isset($grupos) and is_array($grupos) and count($grupos)>0) {
                            # code...
                           ...
                           <option value="<?php echo $key->id ?>" id="<?php  echo $key->id?>"><?php echo $key->nombre_grupo ?></option>
            ...
            <br>
                        ...
                        <div class="row">
                          <div class="col-md-12 text-center">
                            ...
                            <a data-toggle="tooltip" title="" href="<?php echo base_url().'img'.'/migraciones'.'/medicos/'.'medicos.csv' ?>" class="btn btn-danger" data-original-title="Descarga el archivo para el reporte"><i class="fa fa-download"></i> Descargar reporte para llenado</a>
